...
public enum TL {
    ...
    COMMAND_CHEST_DESCRIPTION("Open faction chest"),

    COMMAND_CHESTLOGS_DESCRIPTION("View faction chest logs"),
    
    COMMAND_CHECKLOGS_DESCRIPTION("View faction logs"),

    COMMAND_CHECK_DESCRIPTION("Mark your faction walls as checked"),
    COMMAND_ALARM_DESCRIPTION("Sound your faction alarm"),

    COMMAND_COOOLDOWN("&cYou are currently on command cooldown for another &6%1$s seconds&c."),
    ...
    COMMAND_COLEADER_REVOKES("<i>You have removed co-leader status from %1$s<i>."),
    COMMAND_COLEADER_REVOKED("%1$s<i> is no longer co-leader in your faction."),
    COMMAND_COLEADER_PROMOTES("%1$s<i> was promoted to co-leader in your faction."),
    COMMAND_COLEADER_PROMOTED("<i>You have promoted %1$s<i> to co-leader."),
    ...
    COMMAND_FLY_CHANGE("&8» &eFaction flight has been &d%1$s"),
    COMMAND_FLY_DAMAGE("&8» &cFaction flight has been disabled due to damage."),
    COMMAND_FLY_NO_ACCESS("&cCannot fly in territory of %1$s"),
    COMMAND_FLY_ENEMY_DISABLE("&8» &cFaction flight has been disabled due to a nearby enemy."),
    ...
    COMMAND_HISTORY_DESCRIPTION("View a players faction history"),

    COMMAND_INSPECT_DESCRIPTION("Enter faction inspection mode"),
    COMMAND_INSPECT_ENABLE("&8» &aInspecting has been enabled."),
    COMMAND_INSPECT_DISABLE("&8» &CInspecting has been disabled."),
    ...
    COMMAND_UNMUTE_DESCRIPTION("Un-mute a player in your faction"),
    COMMAND_MUTE_DESCRIPTION("Mute a player in your faction"),
    
    COMMAND_MUTELIST_DESCRIPTION("List all muted players"),
    ...
    COMMAND_MISSION_DESCRIPTION("Allows you to view and start missions"),
    ...
    COMMAND_OPTIONS_DESCRIPTION("Edit your faction options"),
    ...
    COMMAND_SETALARM_DESCRIPTION("Set your time between faction alarm messages"),
    
    COMMAND_SETWALLCHECK_DESCRIPTION("Set your time inbetween wall checks"),
    ...
    COMMAND_STEALTH_DESCRIPTION("Enter stealth mode so enemies fly doesn't disable"),
    COMMAND_STEALTH_ENABLE("&8» &aFaction Stealth has been enabled."),
    COMMAND_STEALTH_DISABLE("&8» &cFaction Stealth has been disabled."),

    COMMAND_SETMOTD_DESCRIPTION("Set your factions welcoming message"),
    ...
    COMMAND_TNT_INVALID_NUM("<b>The amount needs to be a number!"),
    COMMAND_TNT_EXCEEDLIMIT("<b>This exceeds the bank limit!"),
    COMMAND_TNT_WIDTHDRAW_NOTENOUGH("<b>Not enough tnt in bank."),
    COMMAND_TNT_DEPOSIT_NOTENOUGH("<b>Not enough tnt in your inventory."),
    COMMAND_TNT_POSITIVE("<b>Please use positive numbers!"),
    COMMAND_TNT_DESCRIPTION("deposit tnt into your factions tnt bank"),
    COMMAND_TNTCOUNT_DESCRIPTION("count the amount of tnt in your factions bank"),
    ...
    COMMAND_VALUE_DESCRIPTION("View a factions f top value."),
    COMMAND_VALUE_MESSAGE("&eThe faction &6%1$s &ehas the total f top value of %2$s."),
