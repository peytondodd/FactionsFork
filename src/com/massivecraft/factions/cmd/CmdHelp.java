...
public class CmdHelp extends FCommand {
    ...
    public void updateHelp() {
        ...
        pageLines.add(p.cmdBase.cmdInspect.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdValue.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdUpgrade.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdChest.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdChestLogs.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdMissions.getUseageTemplate(true));
        helpPages.add(pageLines);
        
        pageLines = new ArrayList<>();
        pageLines.add(p.cmdBase.cmdTNTFill.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdDepositTNT.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdTNTCount.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdOptions.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdSetMOTD.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdSetAlarmTime.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdSetWallCheck.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdCheck.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdAlarm.getUseageTemplate(true));
        helpPages.add(pageLines);
        
        pageLines = new ArrayList<>();
        pageLines.add(p.cmdBase.cmdUnMute.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdMute.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdMuteList.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdHistory.getUseageTemplate(true));
        pageLines.add(p.cmdBase.cmdCheckLogs.getUseageTemplate(true));
        helpPages.add(pageLines);
