...
public class Conf {
	...
	public static int mobsSpawningUpgradeCost = 10000;
	public static int expDropsUpgradeCost = 10000;
	public static int cropsGrowthUpgradeCost = 10000;
	public static int percentDamageDecreaseCost = 10000;
	public static int percentDamageIncreaseCost = 10000;
	public static int fChest2UpgradeCost = 10000;
	public static int moreMembersUpgradeCost = 10000;
	public static int tntBankUpgradeCost = 10000;
	public static int moreWarpsUpgradeCost = 10000;

	public static int sugarCaneStartingReward = 10000;
	public static int glassMinedStartingReward = 10000;
	public static int blazeKilledStartingReward = 10000;
	public static int blocksMinedStartingReward = 10000;

	public static int sugarCaneIncreaseReward = 3000;
	public static int glassMinedIncreaseReward = 3000;
	public static int blazeKilledIncreaseReward = 3000;
	public static int blocksMinedIncreaseReward = 3000;

	public static int sugarCaneStartingAmount = 500;
	public static int glassMinedStartingAmount = 1000;
	public static int blazeKilledStartingAmount = 100;
	public static int blocksMinedStartingAmount = 20000;

	public static int sugarCaneIncreaseAmount = 100;
	public static int glassMinedIncreaseAmount = 100;
	public static int blazeKilledIncreaseAmount = 100;
	public static int blocksMinedIncreaseAmount = 100;
	...
	public static int defaultFactionMemberLimit = 35;
	public static int upgradedFactionMemberLimit = 60;
	...
	public static int autoLeaveRoutineMaxMillisecondsPerTick = 5; // 1 server
																	// tick is
																	// roughly
																	// 50ms, so
																	// default
	...
	public static boolean autoLeaveDeleteFPlayerData = true; // Let them just
																// remove player
																// from Faction.
	...
	// (optional) set minimum zoom level before layer is visible (0 = default,
	// always visible)
	...
	// Enable the %money% macro. Only do this if you know your economy manager
	// is thread-safe.
	public static boolean dynmapDescriptionMoney = false;

	// Allow players in faction to see one another on Dynmap (only relevant if
	// Dynmap has 'player-info-protected' enabled)
	...
	// To show all regions on a given world, add 'world:<worldname>' to the
	// list.
	public static Set<String> dynmapVisibleFactions = new HashSet<>();

	// Optional setting to hide specific Factions.
	// Specify Faction either by name or UUID.
	// To hide all regions on a given world, add 'world:<worldname>' to the
	// list.
	...
	public static DynmapStyle dynmapDefaultStyle = new DynmapStyle().setStrokeColor(DYNMAP_STYLE_LINE_COLOR)
			.setLineOpacity(DYNMAP_STYLE_LINE_OPACITY).setLineWeight(DYNMAP_STYLE_LINE_WEIGHT).setFillColor(DYNMAP_STYLE_FILL_COLOR)
			.setFillOpacity(DYNMAP_STYLE_FILL_OPACITY).setHomeMarker(DYNMAP_STYLE_HOME_MARKER).setBoost(DYNMAP_STYLE_BOOST);

	// Optional per Faction style overrides. Any defined replace those in
	// dynmapDefaultStyle.
	// Specify Faction either by name or UUID.
	public static Map<String, DynmapStyle> dynmapFactionStyles = ImmutableMap.of("SafeZone", new DynmapStyle().setStrokeColor("#FF00FF")
			.setFillColor("#FF00FF").setBoost(false), "WarZone", new DynmapStyle().setStrokeColor("#FF0000").setFillColor("#FF0000").setBoost(false));
