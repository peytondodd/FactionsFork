...
public class WallCheckGUI {

	public static void open(FPlayer p) {
		Inventory inv = Bukkit.createInventory(null, 36, p.getFaction().getTag() + "'s Wall Check Time");
		...
		minute2.setItemMeta(minute2meta);
		...
		ItemStack hour4 = new ItemStack(Material.PAPER);
		ItemMeta hour4meta = hour4.getItemMeta();
		hour4meta.setDisplayName(ChatColor.GREEN + "4 Hours");
		hour4.setItemMeta(hour4meta);
		
		ItemStack hour5 = new ItemStack(Material.PAPER);
		ItemMeta hour5meta = hour5.getItemMeta();
		hour5meta.setDisplayName(ChatColor.GREEN + "5 Hours");
		hour5.setItemMeta(hour5meta);
		
		ItemStack hour10 = new ItemStack(Material.PAPER);
		ItemMeta hour10meta = hour10.getItemMeta();
		hour10meta.setDisplayName(ChatColor.GREEN + "10 Hours");
		hour10.setItemMeta(hour10meta);
		
		ItemStack hour15 = new ItemStack(Material.PAPER);
		ItemMeta hour15meta = hour15.getItemMeta();
		hour15meta.setDisplayName(ChatColor.GREEN + "15 Hours");
		hour15.setItemMeta(hour15meta);
		
		ItemStack hour24 = new ItemStack(Material.PAPER);
		ItemMeta hour24meta = hour24.getItemMeta();
		hour24meta.setDisplayName(ChatColor.GREEN + "24 Hours");
		hour24.setItemMeta(hour24meta);
		...
		inv.setItem(0, seconds30);
		inv.setItem(1, minute1);
		inv.setItem(2, minute2);
		inv.setItem(3, minute3);
		inv.setItem(4, minute4);
		inv.setItem(5, minute5);
		inv.setItem(6, minute6);
		inv.setItem(7, minute7);
		inv.setItem(8, minute8);
		inv.setItem(9, minute9);
		inv.setItem(10, minute10);
		inv.setItem(11, minute15);
		inv.setItem(12, minute20);
		inv.setItem(13, minute25);
		inv.setItem(14, minute30);
		inv.setItem(15, minute45);
		inv.setItem(16, hour1);
		inv.setItem(17, hour2);
		inv.setItem(18, hour3);
		inv.setItem(19, hour4);
		inv.setItem(20, hour5);
		inv.setItem(21, hour10);
		inv.setItem(22, hour15);
		inv.setItem(23, hour24);
